...
class Schedule {
    ...
    /**
     * Get all schedules in descending date order.
     */
    ...
    /**
     * Get schedule by ID with active booking details.
     */
    public function getByIdWithBooking($id) {
    ...
    /**
     * Get poojas with booking info for a specific date.
     */
    public function getAllWithBookingsByDate($selectedDate) {
        $stmt = $this->conn->prepare("
            SELECT 
                ps.id,
                ps.pooja_name,
    ...
    /**
     * Get schedules by calendar year.
     */
    public function getByYear($year) {
        $stmt = $this->conn->prepare("
            SELECT id, pooja_name, pooja_date, time_slot, status
            FROM pooja_schedule
            WHERE YEAR(pooja_date) = ?
            ORDER BY pooja_date ASC, time_slot ASC
        ");
